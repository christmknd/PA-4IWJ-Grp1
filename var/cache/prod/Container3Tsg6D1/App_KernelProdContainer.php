...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\MentionLegaleController' => 'getMentionLegaleControllerService',
            'App\\Controller\\PlateformeController' => 'getPlateformeControllerService',
            'App\\Controller\\RegisterEventController' => 'getRegisterEventControllerService',
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        return $this->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['App\\Security\\Voter\\AnnonceVoter'] ?? $this->load('getAnnonceVoterService'));
            yield 4 => ($this->privates['App\\Security\\Voter\\EvenementVoter'] ?? $this->load('getEvenementVoterService'));
            yield 5 => ($this->privates['App\\Security\\Voter\\UserVoter'] ?? ($this->privates['App\\Security\\Voter\\UserVoter'] = new \App\Security\Voter\UserVoter()));

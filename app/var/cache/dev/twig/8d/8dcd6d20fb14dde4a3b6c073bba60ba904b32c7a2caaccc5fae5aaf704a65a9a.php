...
class __TwigTemplate_95ef8cdd92ff78bb332cb0e4c12d4a80caa25d62d9e5c77abe13038423855cb6 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "BackEnd/user/_form.html.twig", ["button_label" => "Enregistrer"]);
        echo "

    <a href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_users_show", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10)]), "html", null, true);
        echo "\">
...
{% block body %}
    ...
    {{ include('BackEnd/user/_form.html.twig', {'button_label': 'Enregistrer'}) }}
...
{% endblock %}
", "BackEnd/user/edit.html.twig", "/Users/dev/Desktop/PA-4IWJ-Grp1/app/templates/BackEnd/user/edit.html.twig");
    }
}

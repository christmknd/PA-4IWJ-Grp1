...
class __TwigTemplate_8995146e4bc4aca06526392eece7db49675fa5f4ed6cf4ba69d7530da6ad13c8 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Page not found - Carte des Animeaux";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Page not found - Carte des Animeaux</h1>
...
{% block title %}Page not found - Carte des Animeaux{% endblock %}

{% block body %}
    <h1>Page not found - Carte des Animeaux</h1>

    <p>
        The requested page couldn't be located. Checkout for any URL
        misspelling or <a href=\"{{ path('default') }}\">return to the homepage</a>.
    </p>
{% endblock %}", "@Twig/Exception/error.html.twig", "/Users/dev/Desktop/PA-4IWJ-Grp1/app/templates/bundles/TwigBundle/Exception/error.html.twig");
    }
}

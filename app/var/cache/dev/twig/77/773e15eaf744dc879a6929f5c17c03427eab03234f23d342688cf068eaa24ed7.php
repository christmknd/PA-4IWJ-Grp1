...
class __TwigTemplate_613fb2ee935681008da9409fc389faf6ee9afaa3f34ec6638719a1abd402fab6 extends Template
{
    private $source;
    private $macros = [];
...
{% block title %}Ajouter User{% endblock %}

{% block body %}
    <h1>Créer User</h1>

    {{ include('BackEnd/user/_form.html.twig') }}

    <a class=\"btn\" href=\"{{ path('admin_users') }}\">back to list</a>
{% endblock %}
", "BackEnd/user/new.html.twig", "/Users/dev/Desktop/PA-4IWJ-Grp1/app/templates/BackEnd/user/new.html.twig");
    }
}

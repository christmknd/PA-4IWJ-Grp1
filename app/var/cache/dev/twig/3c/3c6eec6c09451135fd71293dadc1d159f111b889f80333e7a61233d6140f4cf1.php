...
class __TwigTemplate_6b81591abd1ed7b6feb36f2d0d4c978e22f0b8b5d0c900681ff38d92ce21d7bb extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\"
       onsubmit=\"return confirm('Êtes-vous sur de vouloir supprimer votre compte ?');\">
...
";
    ...
    {
        return new Source("<form  method=\"post\" action=\"{{ path('user_delete') }}\"
       onsubmit=\"return confirm('Êtes-vous sur de vouloir supprimer votre compte ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button style =\"background-color: #B0413E; margin: 5px\" class=\"btn\">Supprimer mon compte</button>
</form>
", "user/_delete_form.html.twig", "/Users/dev/Desktop/PA-4IWJ-Grp1/app/templates/user/_delete_form.html.twig");
    }
}
